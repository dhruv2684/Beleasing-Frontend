      ...
      <Container fluid>
        <Row className='align-items-center'>
          <div className="col-md-7 col-12 order-md-1 order-2">
            ...
            <p className='c-g'>In tellus interdum mollis enim aenean lectus pellentesque leo. Elit enim pellentesque.</p>
          </div>
          <div className="col-md-5 col-12 order-md-2 order-1">
            <img className='mt-4' src="https://themes.muffingroup.com/be/leasing2/wp-content/uploads/2023/02/beleasing2-category1.webp" width="100%" alt="" />
          </div>
        </Row>
      </Container>
