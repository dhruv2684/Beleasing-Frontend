      ...
      <Container fluid>
        <Row className='align-items-center'>
          <div className="col-md-7 col-12 order-md-1 order-2">
            ...
            <p className='c-g'>Amet nibh sagittis massa eget vehicula sed dui. Vitae neque luctus sit porta eros platea <br></br> ultrices. Et magna.</p>
          </div>
          <div className="col-md-5 col-12 order-md-2 order-1">
            <img className='mt-4' src="https://themes.muffingroup.com/be/leasing2/wp-content/uploads/2023/02/beleasing2-category4.webp" width="100%" alt="" />
          </div>
        </Row>
      </Container>
        ...
        <Row className='mt-lg-5 mt-3 g-4'>
          <div className="col-lg-4 col-md-6 col-12">
            <div className='bg-white pb-4'>
              <Link to="/bmw-commodo-ipsum"><img src="https://themes.muffingroup.com/be/leasing2/wp-content/uploads/2023/02/beleasing2-product-pic1.webp" width="100%" alt="" /></Link>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className='bg-white pb-4'>
              ...
              <div className='pt-4 ms-4 me-4'>
                ...
                <p className='c-g'><span className='c-g pb-2'>$</span>5,000.00</p>
                <div className='d-flex border-top pt-3 align-items-center justify-content-between'>
                  <p className='mb-0'>Check details</p>
                  <a href=""> <FaArrowRight className='text-dark' /></a>
                </div>
